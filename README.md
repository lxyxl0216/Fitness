...
<img src="docs/screenshots/home.png" width="240" alt="今日营养与训练入口"> <img src="docs/screenshots/exercise-library.png" width="240" alt="动作库与 3D 人体入口"> <img src="docs/screenshots/muscle-atlas.png" width="240" alt="可交互的 3D 人体肌群导航">
...
界面采用午夜蓝黑、酒红、古金与暖白配色；可在「我的 → 界面外观」手动切换浅色或深色，并自动记住选择。使用系统字体、原生导航和表单，兼顾字体放大与触控。
