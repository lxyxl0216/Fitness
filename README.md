...
- **训练 / 动作**：20 个常见动作，按肌群、器械与名称筛选；动作详情显示上次完成记录，可保存自己的 HTTPS 演示链接。
...
尚未接入 3D 人体、动作 GIF、照片、自动加重建议、AI 食谱、HealthKit、iCloud 同步、Apple Watch。[参考 GIF 仓库](https://github.com/JahelCuadrado/ExerciseGymGifsDB)声明不拥有 GIF 版权且无法授予授权，因此没有下载或打包其资源。动作卡使用系统图标，演示链接由使用者添加。
